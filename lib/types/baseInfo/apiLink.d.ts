...
export declare const ENDPOINT = "https://api.sol-fx.io";
export declare const SOL_FX_MAINNET: {
    ...
    readonly tokenInfo: "/v2/sdk/token/sol-fx.mainnet.json";
    ...
    readonly clmmPools: "/v2/solforex-amm-v3/ammPools";
    readonly clmmConfigs: "/v2/solforex-amm-v3/ammConfigs";
    readonly clmmPositionLine: "/v2/solforex-amm-v3/positionLine/<poolId>";
};

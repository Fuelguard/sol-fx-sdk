...
class Liquidity extends base_1.Base {
    ...
    static makeCreatePoolV4InstructionV2Simple(_b) {
        return __awaiter(this, arguments, void 0, function* ({ connection, programId, marketInfo, baseMintInfo, quoteMintInfo, baseAmount, quoteAmount, startTime, ownerInfo, associatedOnly = false, computeBudgetConfig, checkCreateATAOwner = false, makeTxVersion, lookupTableCache, feeDestinationId, }) {
            const frontInstructions = [];
            const endInstructions = [];
            const frontInstructionsType = [];
            const endInstructionsType = [];
    ...
    static makeRemoveAllLpAndCreateClmmPosition(_b) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolKeys, removeLpAmount, userKeys, clmmPoolKeys, createPositionInfo, farmInfo, computeBudgetConfig, checkCreateATAOwner = false, getEphemeralSigners, makeTxVersion, lookupTableCache, }) {
            ...
            const amountIn = removeLpAmount.add((_c = farmInfo === null || farmInfo === void 0 ? void 0 : farmInfo.amount) !== null && _c !== void 0 ? _c : new bn_js_1.default(0));
            ...
            const createPositionIns = yield clmm_1.Clmm.makeOpenPositionFromLiquidityInstructions(Object.assign(Object.assign({ poolInfo: clmmPoolKeys, ownerInfo: {
                    feePayer: (_f = userKeys.payer) !== null && _f !== void 0 ? _f : userKeys.owner,
            ...
            if (farmInfo !== undefined) {
                ...
                for (const item of farmInfo.poolKeys.rewardInfos) {
                    ...
                    rewardTokenAccounts.push((_g = mintToAccount[item.rewardMint.toString()]) !== null && _g !== void 0 ? _g : (yield this._selectOrCreateTokenAccount({
                        programId: common_1.TOKEN_PROGRAM_ID,
            ...
            return {
                ...
                innerTransactions: yield (0, common_1.splitTxAndSigners)({
                    ...
                    makeTxVersion,
                    computeBudgetConfig,
                    payer: (_j = userKeys.payer) !== null && _j !== void 0 ? _j : userKeys.owner,
                    innerTransaction: [
                        { instructionTypes: frontInstructionsType, instructions: frontInstructions, signers },
                        withdrawFarmIns,
     ...
     */
    static fetchInfo(_b) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolKeys }) {
     ...
     */
    static fetchMultipleInfo(_b) {
        return __awaiter(this, arguments, void 0, function* ({ connection, pools, 

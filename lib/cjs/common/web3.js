 ...
 */
function simulateMultipleInstruction(connection_1, instructions_1, keyword_1) {
    return __awaiter(this, arguments, void 0, function* (connection, instructions, keyword, batchRequest = true) {
...
function splitTxAndSigners(_a) {
    return __awaiter(this, arguments, void 0, function* ({ connection, makeTxVersion, innerTransaction, lookupTableCache, computeBudgetConfig, payer, }) {
...
function getMultipleLookupTableInfo(_a) {
    return __awaiter(this, arguments, void 0, function* ({ connection, address, }) {

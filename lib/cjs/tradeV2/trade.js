...
class TradeV2 extends base_1.Base {
    ...
    static fetchMultipleInfo(_c) {
        return __awaiter(this, arguments, void 0, function* ({ connection, pools, batchRequest = true, }) {
    ...
    static makeSwapInstructionSimple(_c) {
        return __awaiter(this, arguments, void 0, function* ({ connection, swapInfo, ownerInfo, computeBudgetConfig, routeProgram, makeTxVersion, lookupTableCache, }) {

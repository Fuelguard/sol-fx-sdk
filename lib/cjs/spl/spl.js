...
class Spl {
    ...
    static makeCreateWrappedNativeAccountInstructions(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, owner, payer, amount, 
        // baseRentExemption,
        commitment, }) {
            const instructions = [];
    ...
    static insertCreateWrappedNativeAccount(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, owner, payer, amount, instructions, instructionsType, signers, commitment, }) {

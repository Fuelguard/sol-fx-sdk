...
class Farm extends base_1.Base {
    ...
    static makeCreateFarmInstructionV6(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, userKeys, poolInfo }) {
            var _b, _c, _d;
            const payer = (_b = userKeys.payer) !== null && _b !== void 0 ? _b : userKeys.owner;
    ...
    /* ================= fetch data ================= */
    static fetchMultipleInfoAndUpdate(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, pools, owner, config, chainTime, }) {
    ...
    static makeCreatorWithdrawFarmRewardInstructionV6Simple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolKeys, userKeys, withdrawMint, makeTxVersion, lookupTableCache, computeBudgetConfig, }) {
            var _b, _c, _d, _e;
            const frontInstructions = [];
            const endInstructions = [];
            const frontInstructionsType = [];
            ...
            return {
                ...
                innerTransactions: yield (0, common_1.splitTxAndSigners)({
                    ...
                    makeTxVersion,
                    computeBudgetConfig,
                    payer: (_e = userKeys.payer) !== null && _e !== void 0 ? _e : userKeys.owner,
                    innerTransaction: [
    ...
    static makeCreateFarmInstructionV6Simple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, userKeys, poolInfo, makeTxVersion, lookupTableCache, computeBudgetConfig, }) {
            var _b, _c, _d, _e;
            const payer = (_b = userKeys.payer) !== null && _b !== void 0 ? _b : userKeys.owner;
            const farmId = (0, base_1.generatePubKey)({ fromPublicKey: payer, programId: poolInfo.programId });
            const lamports = yield connection.getMinimumBalanceForRentExemption(layout_1.FARM_STATE_LAYOUT_V6.span);
    ...
    static makeRestartFarmInstructionV6Simple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolKeys, userKeys, newRewardInfo, makeTxVersion, lookupTableCache, computeBudgetConfig, }) {
            var _b, _c, _d, _e;
            ...
            const rewardVault = (_b = rewardInfo === null || rewardInfo === void 0 ? void 0 : rewardInfo.rewardVault) !== null && _b !== void 0 ? _b : web3_js_1.PublicKey.default;
            const frontInstructions = [];
            const endInstructions = [];
            const frontInstructionsType = [];
            const endInstructionsType = [];
    ...
    static makeFarmCreatorAddRewardTokenInstructionV6Simple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolKeys, userKeys, newRewardInfo, makeTxVersion, lookupTableCache, computeBudgetConfig, }) {
            var _b, _c, _d;
    ...
    static makeDepositInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolKeys, fetchPoolInfo, ownerInfo, amount, associatedOnly = true, checkCreateATAOwner = false, makeTxVersion, lookupTableCache, computeBudgetConfig, }) {
            var _b;
    ...
    static makeWithdrawInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, fetchPoolInfo, ownerInfo, amount, associatedOnly = true, checkCreateATAOwner = false, makeTxVersion, lookupTableCache, computeBudgetConfig, }) {
            var _b, _c;
            const ownerMintToAccount = {};
            for (const item of ownerInfo.tokenAccounts) {
                if (associatedOnly) {
            ...
            const ownerLpTokenAccount = (_b = ownerMintToAccount[lpMint.toString()]) !== null && _b !== void 0 ? _b : (yield this._selectOrCreateTokenAccount({
                programId: common_1.TOKEN_PROGRAM_ID,
                mint: lpMint,
            ...
            for (const itemReward of apiPoolInfo.rewardInfos) {
                const rewardUseSOLBalance = ownerInfo.useSOLBalance && itemReward.rewardMint.equals(entity_1.Token.WSOL.mint);
                const ownerRewardAccount = (_c = ownerMintToAccount[itemReward.rewardMint.toString()]) !== null && _c !== void 0 ? _c : (yield this._selectOrCreateTokenAccount({
                    programId: common_1.TOKEN_PROGRAM_ID,
                    mint: itemReward.rewardMint,
                    tokenAccounts: rewardUseSOLBalance ? [] : ownerInfo.tokenAccounts,
                    owner: ownerInfo.wallet,
    ...
    static makeHarvestAllRewardInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, fetchPoolInfos, ownerInfo, associatedOnly = true, checkCreateATAOwner = false, makeTxVersion, lookupTableCache, computeBudgetConfig, }) {
            var _b, _c;
            const ownerMintToAccount = {};
            for (const item of ownerInfo.tokenAccounts) {
                if (associatedOnly) {
     ...
     */
    static makeV1InfoToV2PdaAndHarvestSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, wallet, tokenAccounts, programIdV3, programIdV5, makeTxVersion, lookupTableCache, computeBudgetConfig, }) {
            const mintToAccount = {};
    ...
    static makeDepositTokenInstruction(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, programId, governanceProgramId, voteWeightAddinProgramId, realm, communityTokenMint, owner, poolId, }) {
    ...
    static makeWithdrawTokenInstruction(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, programId, governanceProgramId, voteWeightAddinProgramId, realm, communityTokenMint, owner, poolId, }) {
            const registrar = (0, pda_2.getRegistrarAddress)(voteWeightAddinProgramId, realm, communityTokenMint).publicKey;
            const ownerPda = this.getAssociatedLedgerAccount({ programId, poolId, owner, version: 3 });
            const ownerAccountInfo = yield connection.getAccountInfo(ownerPda);

...
class Clmm extends base_1.Base {
    ...
    // transaction
    static makeCreatePoolInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ makeTxVersion, connection, programId, owner, payer, mint1, mint2, ammConfig, initialPrice, startTime, computeBudgetConfig, lookupTableCache, }) {
            const [mintA, mintB, initPrice] = new bn_js_1.default(mint1.mint.toBuffer()).gt(new bn_js_1.default(mint2.mint.toBuffer()))
                ? [mint2, mint1, new decimal_js_1.default(1).div(initialPrice)]
                : [mint1, mint2, initialPrice];
            const initialPriceX64 = math_1.SqrtPriceMath.priceToSqrtPriceX64(initPrice, mintA.decimals, mintB.decimals);
    ...
    static makeOpenPositionFromLiquidityInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ makeTxVersion, connection, poolInfo, ownerInfo, amountMaxA, amountMaxB, tickLower, tickUpper, liquidity, associatedOnly = true, checkCreateATAOwner = false, withMetadata = 'create', getEphemeralSigners, computeBudgetConfig, lookupTableCache, }) {
    ...
    static makeOpenPositionFromBaseInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfo, ownerInfo, tickLower, tickUpper, base, baseAmount, otherAmountMax, associatedOnly = true, checkCreateATAOwner = false, computeBudgetConfig, withMetadata = 'create', makeTxVersion, lookupTableCache, getEphemeralSigners, }) {
            const frontInstructions = [];
            const endInstructions = [];
            const frontInstructionsType = [];
            const endInstructionsType = [];
    ...
    static makeIncreasePositionFromLiquidityInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfo, ownerPosition, ownerInfo, amountMaxA, amountMaxB, liquidity, associatedOnly = true, checkCreateATAOwner = false, computeBudgetConfig, makeTxVersion, lookupTableCache, }) {
            const frontInstructions = [];
            const endInstructions = [];
            const frontInstructionsType = [];
            const endInstructionsType = [];
    ...
    static makeIncreasePositionFromBaseInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfo, ownerPosition, ownerInfo, base, baseAmount, otherAmountMax, associatedOnly = true, checkCreateATAOwner = false, computeBudgetConfig, makeTxVersion, lookupTableCache, }) {
            const frontInstructions = [];
            const endInstructions = [];
            const frontInstructionsType = [];
            const endInstructionsType = [];
    ...
    static makeDecreaseLiquidityInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfo, ownerPosition, ownerInfo, liquidity, amountMinA, amountMinB, associatedOnly = true, checkCreateATAOwner = false, computeBudgetConfig, makeTxVersion, lookupTableCache, }) {
            const frontInstructions = [];
            const endInstructions = [];
            const frontInstructionsType = [];
            const endInstructionsType = [];
    ...
    static makeSwapBaseInInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfo, ownerInfo, inputMint, amountIn, amountOutMin, priceLimit, remainingAccounts, associatedOnly = true, checkCreateATAOwner = false, computeBudgetConfig, makeTxVersion, lookupTableCache, }) {
            const frontInstructions = [];
            const endInstructions = [];
            const frontInstructionsType = [];
            const endInstructionsType = [];
    ...
    static makeSwapBaseOutInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfo, ownerInfo, outputMint, amountOut, amountInMax, priceLimit, remainingAccounts, associatedOnly = true, checkCreateATAOwner = false, computeBudgetConfig, makeTxVersion, lookupTableCache, }) {
            const frontInstructions = [];
            const endInstructions = [];
            const frontInstructionsType = [];
            const endInstructionsType = [];
    ...
    static makeCLosePositionInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ poolInfo, ownerPosition, ownerInfo, makeTxVersion, lookupTableCache, connection, }) {
    ...
    static makeInitRewardInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfo, ownerInfo, rewardInfo, chainTime, associatedOnly = true, checkCreateATAOwner = false, makeTxVersion, lookupTableCache, }) {
    ...
    static makeInitRewardsInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfo, ownerInfo, rewardInfos, associatedOnly = true, checkCreateATAOwner = false, computeBudgetConfig, makeTxVersion, lookupTableCache, }) {
    ...
    static makeSetRewardInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfo, ownerInfo, rewardInfo, chainTime, associatedOnly = true, checkCreateATAOwner = false, makeTxVersion, lookupTableCache, }) {
            logger.assertArgument(rewardInfo.endTime > rewardInfo.openTime, 'reward time error', 'rewardInfo', rewardInfo);
            logger.assertArgument(rewardInfo.openTime > chainTime, 'reward must be paid later', 'rewardInfo', rewardInfo);
            const frontInstructions = [];
    ...
    static makeSetRewardsInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfo, ownerInfo, rewardInfos, chainTime, associatedOnly = true, checkCreateATAOwner = false, computeBudgetConfig, makeTxVersion, lookupTableCache, }) {
            const frontInstructions = [];
            const endInstructions = [];
            const frontInstructionsType = [];
            const endInstructionsType = [];
    ...
    static makeCollectRewardInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfo, ownerInfo, rewardMint, associatedOnly = true, checkCreateATAOwner = false, computeBudgetConfig, makeTxVersion, lookupTableCache, }) {
            const frontInstructions = [];
            const endInstructions = [];
            const frontInstructionsType = [];
            const endInstructionsType = [];
    ...
    static makeCollectRewardsInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfo, ownerInfo, rewardMints, associatedOnly = true, checkCreateATAOwner = false, computeBudgetConfig, makeTxVersion, lookupTableCache, }) {
            const frontInstructions = [];
            const endInstructions = [];
            const frontInstructionsType = [];
            const endInstructionsType = [];
    ...
    static makeHarvestAllRewardInstructionSimple(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, fetchPoolInfos, ownerInfo, associatedOnly = true, checkCreateATAOwner = false, makeTxVersion, lookupTableCache, }) {
            var _b, _c, _d;
            ...
            for (const itemInfo of Object.values(fetchPoolInfos)) {
                ...
                const mintAUseSOLBalance = ownerInfo.useSOLBalance && poolInfo.mintA.mint.equals(entity_1.Token.WSOL.mint);
                const mintBUseSOLBalance = ownerInfo.useSOLBalance && poolInfo.mintB.mint.equals(entity_1.Token.WSOL.mint);
                const ownerTokenAccountA = (_b = ownerMintToAccount[poolInfo.mintA.mint.toString()]) !== null && _b !== void 0 ? _b : (yield this._selectOrCreateTokenAccount({
                    programId: poolInfo.mintA.programId,
                    mint: poolInfo.mintA.mint,
                    tokenAccounts: mintAUseSOLBalance ? [] : ownerInfo.tokenAccounts,
                    owner: ownerInfo.wallet,
                ...
                const ownerTokenAccountB = (_c = ownerMintToAccount[poolInfo.mintB.mint.toString()]) !== null && _c !== void 0 ? _c : (yield this._selectOrCreateTokenAccount({
                    programId: poolInfo.mintB.programId,
                    mint: poolInfo.mintB.mint,
                    tokenAccounts: mintBUseSOLBalance ? [] : ownerInfo.tokenAccounts,
                    owner: ownerInfo.wallet,
                ...
                for (const itemReward of poolInfo.rewardInfos) {
                    const rewardUseSOLBalance = ownerInfo.useSOLBalance && itemReward.tokenMint.equals(entity_1.Token.WSOL.mint);
                    const ownerRewardAccount = (_d = ownerMintToAccount[itemReward.tokenMint.toString()]) !== null && _d !== void 0 ? _d : (yield this._selectOrCreateTokenAccount({
                        programId: itemReward.tokenProgramId,
                        mint: itemReward.tokenMint,
                        tokenAccounts: rewardUseSOLBalance ? [] : ownerInfo.tokenAccounts,
                        owner: ownerInfo.wallet,
    ...
    // instrument
    static makeCreatePoolInstructions(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, programId, owner, mintA, mintB, ammConfigId, initialPriceX64, startTime, }) {
    ...
    static makeOpenPositionFromLiquidityInstructions(_a) {
        return __awaiter(this, arguments, void 0, function* ({ poolInfo, ownerInfo, tickLower, tickUpper, liquidity, amountMaxA, amountMaxB, withMetadata, getEphemeralSigners, }) {
            const signers = [];
            let nftMintAccount;
    ...
    static makeOpenPositionFromBaseInstructions(_a) {
        return __awaiter(this, arguments, void 0, function* ({ poolInfo, ownerInfo, tickLower, tickUpper, base, baseAmount, otherAmountMax, withMetadata, getEphemeralSigners, }) {
            const signers = [];
            let nftMintAccount;
            if (getEphemeralSigners) {
                nftMintAccount = new web3_js_1.PublicKey((yield getEphemeralSigners(1))[0]);
    ...
    static computeAmountOutAndCheckToken(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfo, tickArrayCache, baseMint, amountIn, slippage, priceLimit = new decimal_js_1.default(0), catchLiquidityInsufficient = false, }) {
    ...
    static computeAmountInAndCheckToken(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfo, tickArrayCache, baseMint, amountOut, slippage, priceLimit = new decimal_js_1.default(0), }) {
            const epochInfo = yield connection.getEpochInfo();
            const token2022Infos = yield (0, base_1.fetchMultipleMintInfos)({
                connection,
                mints: [poolInfo.mintA, poolInfo.mintB]
    ...
    // fetch data
    static fetchMultiplePoolInfos(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolKeys, ownerInfo, chainTime, batchRequest = false, updateOwnerRewardAndFee = true, }) {
            var _b;
            ...
            if (ownerInfo) {
                ...
                for (const itemAccountInfo of positionAccountInfos) {
                    ...
                    poolsInfo[itemPoolId].positionAccount = [
                        ...((_b = poolsInfo[itemPoolId].positionAccount) !== null && _b !== void 0 ? _b : []),
                        {
    ...
    static fetchMultiplePoolTickArrays(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolKeys, batchRequest, }) {
    ...
    static fetchExBitmaps(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, exBitmapAddress, batchRequest, }) {
    ...
    static getWhiteListMint(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, programId }) {

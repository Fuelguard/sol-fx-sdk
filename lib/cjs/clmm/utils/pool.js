...
class PoolUtils {
    ...
    static updatePoolRewardInfos(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, apiPoolInfo, chainTime, poolLiquidity, rewardInfos, }) {
            var _b, _c, _d;
            const nRewardInfo = [];
            for (let i = 0; i < rewardInfos.length; i++) {
                const _itemReward = rewardInfos[i];
                const apiRewardProgram = (_c = (_b = apiPoolInfo.rewardInfos[i]) === null || _b === void 0 ? void 0 : _b.programId) !== null && _c !== void 0 ? _c : (_d = (yield connection.getAccountInfo(_itemReward.tokenMint))) === null || _d === void 0 ? void 0 : _d.owner;

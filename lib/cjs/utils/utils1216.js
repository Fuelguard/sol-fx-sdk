...
class Utils1216 extends base_1.Base {
    ...
    static getAllInfo(_b) {
        return __awaiter(this, arguments, void 0, function* ({ connection, programId, poolIds, wallet, chainTime, }) {
            if (poolIds.length === 0)
                return [];
    ...
    static makeClaimInstructionSimple(_b) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfo, ownerInfo, makeTxVersion, lookupTableCache, }) {
    ...
    static makeClaimAllInstructionSimple(_b) {
        return __awaiter(this, arguments, void 0, function* ({ connection, poolInfos, ownerInfo, makeTxVersion, lookupTableCache, }) {
            var _c;
            const frontInstructions = [];
            const frontInstructionsType = [];
            const endInstructions = [];
            ...
            for (const poolInfo of poolInfos) {
                const ownerVaultList = [];
                for (const itemToken of poolInfo.tokenInfo) {
                    const tempVault = (_c = tempNewVault[itemToken.mintAddress.toString()]) !== null && _c !== void 0 ? _c : (yield this._selectOrCreateTokenAccount({
                        programId: itemToken.programId,
                        mint: itemToken.mintAddress,
                        tokenAccounts: itemToken.mintAddress.equals(entity_1.Token.WSOL.mint) ? [] : ownerInfo.tokenAccounts,
                        owner: ownerInfo.wallet,

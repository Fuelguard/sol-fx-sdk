...
class MarketV2 extends base_1.Base {
    static makeCreateMarketInstructionSimple(_a) {
    ...
    static makeCreateMarketInstruction(_a) {
        return __awaiter(this, arguments, void 0, function* ({ connection, wallet, marketInfo, }) {
            const ins1 = [];
